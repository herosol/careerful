                        ...
                        <div class="row">
                            <div class="">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        <label for="event_type" class="control-label">Event Type<span class="symbol required">*</span></label>
                                        <select name="event_type" id="event_type" class="form-control" required>
                                            <option value=''>-- Select --</option>
                                            <?php foreach (['virtual', 'social', 'company', 'awesome'] as $value) : ?>
                                                <option value="<?= $value ?>" <?= $row->event_type == $value ? 'selected' : '' ?>><?= $value ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>    
                                    <div class="col-md-12">
            ...
            <?php if (count($blogs) > 0): $count = 0; ?>
                <?php foreach ($blogs as $blog):  ?>                    
                    <tr class="odd gradeX">
                        ...
                        <td><?= $blog->title ?><br/>&nbsp;<b><?= ucfirst($blog->event_type);?> Event</b></td>
